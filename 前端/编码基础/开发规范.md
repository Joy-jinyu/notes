...
+ VS支持`eslint`检测
  ...
  + 【目前未可用】安装插件`perttier、eslint-plugin-prettier、eslint-config-prettier`, 并添加[配置文件`.prettierrc.js`](https://prettier.io/docs/en/options.html?spm=a2c4e.11153940.blogcont422690.11.5d0b5721zZ3CkZ)，并配置`.eslint.js`
